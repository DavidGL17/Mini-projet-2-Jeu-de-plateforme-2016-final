...
import platform.game.Actors.actorSignal.SignalInvisibleCollision;
...
public class LevelBoss extends Level{
	 ...
	 public void register(World world) {
		    ...
		    world.register(new Block(new Box(new Vector(7, 7), 20, 8), world.getLoader().getSprite("castle.top2")));
		    world.register(new Block(new Box(new Vector(27, 7), 20, 8), world.getLoader().getSprite("castle.top")));
		    ...
		    world.register(new Block(new Box(new Vector(0, -18), 6, 6), world.getLoader().getSprite("castle.middle.left3")));
		    world.register(new Block(new Box(new Vector(0, -24), 6, 6), world.getLoader().getSprite("castle.middle.left3")));
		    ...
		    world.register(new Block(new Box(new Vector(36, -24), 6, 6), world.getLoader().getSprite("castle.center3")));
			...
			world.register(new Block(new Box(new Vector(47, 19), 20, 8), world.getLoader().getSprite("castle.top2")));
			world.register(new Block(new Box(new Vector(67, 19), 20, 8), world.getLoader().getSprite("castle.top2")));
			world.register(new Block(new Box(new Vector(85, 19), 16, 8), world.getLoader().getSprite("castle.top3")));
		    ...
		    world.register(new Block(new Box(new Vector(42, 12), 6, 6), world.getLoader().getSprite("castle.center3")));
		    world.register(new Block(new Box(new Vector(42, 18), 6, 6), world.getLoader().getSprite("castle.center3")));
		    world.register(new Block(new Box(new Vector(40, 12), 6, 6), world.getLoader().getSprite("castle.center3")));
		    world.register(new Block(new Box(new Vector(40, 18), 6, 6), world.getLoader().getSprite("castle.center3")));
		    ...
		    world.register(new Block(new Box(new Vector(84, -18), 6, 6), world.getLoader().getSprite("castle.center3")));
		    world.register(new Block(new Box(new Vector(84, -24), 6, 6), world.getLoader().getSprite("castle.center3")));
		    world.register(new Block(new Box(new Vector(84, -30), 6, 6), world.getLoader().getSprite("castle.center3")));
		    ...
		    world.register(new Block(new Box(new Vector(90, -24), 6, 6), world.getLoader().getSprite("castle.middle.right3")));
		    world.register(new Block(new Box(new Vector(90, -30), 6, 6), world.getLoader().getSprite("castle.middle.right3")));
		    ...
		    Slime minion1 = new Slime(new Vector(0, 0), new Vector(64, -8.5),0.01,4, new Box(new Vector(65.5, -8), 20, 5), loader, 1,1,false);
	   		...
	   		MoverLava lava = new MoverLava(new Vector(66, -22), new Vector(66, 5), 30, 16,new Box(new Vector(66,-18), 30,13), 0.09, world.getLoader(), plaque3, "liquidLavaTop_mid26x4"); // 9s
	    	Heart coeurInterphase2 = new  Heart(new Vector(65, -8), world.getLoader());
		    										// Phase 3
		
			Lava lavaPhase3NoWalljump = new Lava(new Box(new Vector(52.5, -8), 3, 26), loader, "colonnelava");
...
//		    world.register(new Block(new Box(new Vector(132, 4), 6, 6), world.getLoader().getSprite("des2")));
		    ...
		    world.register(new Block(new Box(new Vector(111, -22), 6, 6), world.getLoader().getSprite("grass.center3")));
		    world.register(new Block(new Box(new Vector(105, -22), 6, 6), world.getLoader().getSprite("grass.center3")));
		    world.register(new Block(new Box(new Vector(99, -22), 6, 6), world.getLoader().getSprite("grass.center3")));
		    world.register(new Block(new Box(new Vector(93, -22), 6, 6), world.getLoader().getSprite("grass.center3")));
		    world.register(new Block(new Box(new Vector(117, -22), 6, 6), world.getLoader().getSprite("grass.center3")));
		    world.register(new Block(new Box(new Vector(123, -22), 6, 6), world.getLoader().getSprite("grass.center3")));
		    world.register(new Block(new Box(new Vector(126, -22), 6, 6), world.getLoader().getSprite("grass.center3")));
		    world.register(new Block(new Box(new Vector(132, -22), 6, 6), world.getLoader().getSprite("castle.center3")));

		    world.register(new Block(new Box(new Vector(153, 2), 24, 24), world.getLoader().getSprite("castle.center24_24")));
		    world.register(new Block(new Box(new Vector(153, -22), 24, 24), world.getLoader().getSprite("castle.center24_24")));
		    world.register(new Block(new Box(new Vector(141, 15), 24, 24), world.getLoader().getSprite("castle.center24_24")));
		    ...
		    world.register(new BlockDeco(new Vector(20, 19), 20, 100, world.getLoader(), "Background_112"));
		    world.register(new BlockDeco(new Vector(120, 19), 20, 100, world.getLoader(), "Background_112"));

		    world.register(new BlockDeco(new Vector(111, -2), 15, 25, world.getLoader(), "Background_18"));
		    world.register(new BlockDeco(new Vector(20, 12), 20, 100, world.getLoader(), "Background_112"));
