...
public class Level_05 extends Level{
    ...
    public void register(World world) {
	    ...
	    Lever lever = new Lever(new Vector(5,1), loader,"lever.right", "lever.left");
	    Mover mover = new Mover(new Vector(15, 4.5), new Vector(14, 10.5), 2, 9, 0.9, loader, lever, "stone.7");
