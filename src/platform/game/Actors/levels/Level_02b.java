...
public class Level_02b extends Level{
	 ...
	 @Override
	    public void register(World world) {
	    	...
	    	world.register(new BlockDeco(new Vector(144, 4), 2, 2, world.getLoader(), "foliagePack_020"));
		    ...
		    world.register(new BlockDeco(new Vector(20, 15), 20, 100, world.getLoader(), "Background_112"));
