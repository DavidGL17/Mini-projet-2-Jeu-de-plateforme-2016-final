...
public class Level_05 extends Level{
    ...
    public void register(World world) {
	    ...
	    world.register(new Teleporteur(new Box(new Vector(0, 1.5), 2.5, 2.5), new Vector(4, -57)));
	    world.register(new Teleporteur(new Box(new Vector(0, -55.5), 2.5, 2.5) , new Vector(4, 0)));
